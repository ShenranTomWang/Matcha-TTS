...
multilingual_data_path = "../"
multilingual_train_filelist_path = "./objiwe_audio_text_train_filelist.txt"
multilingual_test_filelist_path = "./objiwe_audio_text_test_filelist.txt"
multilingual_val_filelist_path = "./objiwe_audio_text_val_filelist.txt"
